...
void setup() {
  ...
  //  car.MotorRight.motor(1, MOTOR12_1KHZ);
  //  car.MotorLeft.motor(4, MOTOR12_1KHZ);
}
void loop() {
...
//  int LeftSpeed;
//  //assume diffvalue>0 as right turn and <0 is a right turn
//  LeftSpeed = BLF536.pwmSetSpeed - (motorDiffPWM);
//  RightSpeed = BLF536.pwmSetSpeed + (MOTORDiffPWM);
//  BLF536.MotorRightPtr->setSpeed(RightSpeed);
//  BLF536.MotorLeftPtr->setSpeed(LeftSpeed);
